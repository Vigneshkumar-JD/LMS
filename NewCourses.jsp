...
<link rel="stylesheet" href="css/Home.css">
 <script src="https://code.jquery.com/jquery-2.2.0.min.js" type="text/javascript"></script>
    ...
    <script src="https://code.jquery.com/jquery-3.5.1.js"></script>
      ...
      <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" integrity="sha512-kCnvHrF01j/AXg/6f+/M6/npEwPpLcv+qKkxX8EaDzv1R5RKeQzK2H5Wddngzv5JXKjyDv0y0qM+ndI6C8LW5w==" crossorigin="anonymous" referrerpolicy="no-referrer" />
...
<main class="main">
  ...
  <section class="landing" style="margin-top:8%;">
    <div class="landing-text" style="margin-bottom: 5%;">
