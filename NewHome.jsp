...
<title>SKILL-SET-GO Homepage</title>
    ...
    <div class="container flex-between">
 	...
 	<img src="images/log.png" alt="Working Illustration"  />	
      ...
      <nav class="main-navgation flex-between flex-ver-top">
        <div class="nav-links" style="margin-left: 10%">
...
window.addEventListener("scroll", function() {
  ...
  if (window.scrollY > 0) {
    header.style.background = "linear-gradient(to right,#83799c, #aba3bc,#d5d0dd,#fff)";
    header.style.color = "#fff";
    navLinks.forEach(link => {
      link.style.color = "#fff";
      link.style.textDecoration = "none";
    });
    logo.src = "images/log1.png";
    signUpButton.style.backgroundColor = "#fff";
    signUpButton.style.color = "#0b0742";
  } else {
    ...
    logo.src = "images/log.png";
    signUpButton.style.backgroundColor = "#0b0742";
  ...
  <section class="landing" style="margin-top:8%;">
    ...
    <div class="landing-image">
      <img src="images/NewHomePic.png" alt="Working Illustration" style="width:70%;" />
    </div>
  </section>
  <!-- Features -->
	...
	%>
	  <div class="box pl">
         ...
         <div class="contentz">
            <h3><%= courseName %></h3>
<p><%= description %></p>
 <button name="courseName" value="<%= courseName %>" onclick="location.href='newlyaddedcoursedesc.jsp?courseName=<%= courseId %>'" class="btn">See More</button>
            <div class="icons">
 ...
 <div class="contaxiner" style="margin-top: 10%;">
   ...
   <center> <h2 style="margin-top:5rem;font-weight:900;">COMING SOON</h2> </center>
     <section class="customer-logos slider" style="margin-top:5rem;width: 100%;">
        <div class="slides" style="margin-right: 20px;width: 40%;" >
...
<%
       ...
       con = DriverManager.getConnection("jdbc:mysql://localhost:3306/lms?","root","saranya@2001");
		...
		while (rs.next()) {
			...
			String imageBase64 = Base64.getEncoder().encodeToString(imageBytes);
	%>
      <div class="contain" style="padding:15px; ">
       <div class="boxy">
         <div class="image">
 <img src="data:image/png;base64,<%= imageBase64 %>" alt="<%= courseName %>">         </div>
         <div class="contenty">
        ...
        <section class="flex-content padding_2x" >
            <form id="form" class="padding_2x">
                ...
                <fieldset>
                    ...
                    <input type="text" name="mail" maxlength="8" />
                </fieldset>
                <fieldset>
                    <label for="service">Choose a course</label>
                    <select name="service" id="service">
                        <option value="0">Select yours</option>
                        <option value="1">Python Certification</option>
                        <option value="2">Java Certification</option>
                ...
                <fieldset>
                    <a class="btn2" href="log.jsp" style="margin-left:25%;margin-top:5%;border:1px solid #f6f6f6;text-decoration:none;width:50%;padding-left:12%;background:linear-gradient(to right,#83799c, #aba3bc,#d5d0dd,#fff);" >SUBMIT DETAILS</a>
                </fieldset>
            </form>
        </section>
    </div>
